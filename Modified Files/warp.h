...
typedef enum
{
	...
	//kWarpTypeMaskBusVoltage     = (1 << 27),
	//kWarpTypeMaskShuntVoltage = (1 << 28),
	//kWarpTypeMaskCurrent 		= (1 << 29),
	//kWarpTypeMaskPower		= (1 << 30),
	//kWarpTypeMaskCalibration	= (1 << 31),

	kWarpTypeMaskRED 	         = (1 << 27),
	kWarpTypeMaskIR              = (1 << 28),
	//kWarpTypeMaskRED_w				= (1 << 29),
	//kWarpTypeMaskIR_w			= (1 << 30),
...
typedef enum
{
	...
	kWarpSensorConfigurationRegisterMAX30102InterruptEnable1	= 0x02,
	kWarpSensorConfigurationRegisterMAX30102InterruptEnable2	= 0x03,
	kWarpSensorConfigurationRegisterMAX30102FIFO_WR_PTR			= 0x04,
	kWarpSensorConfigurationRegisterMAX30102OVF_COUNTER			= 0x05,
	kWarpSensorConfigurationRegisterMAX30102FIFO_RD_PTR			= 0x06,
	kWarpSensorConfigurationRegisterMAX30102FIFO_CON			= 0x08,
    kWarpSensorConfigurationRegisterMAX30102Mode_CON			= 0x09,
	kWarpSensorConfigurationRegisterMAX30102SP02_CON			= 0x0A,
	kWarpSensorConfigurationRegisterMAX30102LED1_PA				= 0x0C,
	kWarpSensorConfigurationRegisterMAX30102LED2_PA				= 0x0D,
...
typedef enum
{
	...
	kWarpSensorOutRegisterMAX30102FIFO_DATA			    = 0X07,

	kWarpSensorOutputRegisterINA219OUT_Config  			= 0x00,
	kWarpSensorOutputRegisterINA219OUT_ShuntVol  		= 0x01,
	kWarpSensorOutputRegisterINA219OUT_BusVol			= 0x02,
